# AI Personal Finance Copilot — Build Plan
...
Modular service-based architecture: Next.js web client; Hono TypeScript API/BFF; Go ingestion worker; Gemini analysis adapter; PostgreSQL system of record; MongoDB for raw import documents and model traces.
...
Next.js, TypeScript, shadcn/ui, Zustand, Hono, Go, Prisma, PostgreSQL, MongoDB, Redis/BullMQ, Gemini API, Docker Compose

## Core domain

User, Account, Import, Transaction, Category, Budget, Subscription, Forecast, Goal, Insight, AuditEvent.

## API strategy

REST for imports and commands; GraphQL queries/mutations for dashboard composition; SSE for import and analysis progress.
